...
| `status`, currently off | `Group friendly fire is off, players in the same group cannot damage each other.` (plus `N hit(s) blocked since restart.` once any have been) |
